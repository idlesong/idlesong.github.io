### Simple NAS
It's cool to have a NAS. But NAS is a bit expensive.
Tplink NS320 + big volume hard disk
...
#### portable storage(offline)
Big volume SD card + card reader
SD card encrption if needed
